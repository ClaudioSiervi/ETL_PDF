...
class DicionarioRegEx():
    ...
    sudeste = {
        ...
        'carga_hora_verif_tp' : 'top:(1139[0-9]|1140[0-9]|1141[0-9]|1229[0-9]|1230[0-9]|1317[0-9]|1318[0-9]|1319[0-9])px',
        'carga_hora_verif_lf' : 'left:(22[0-9]|23[0-9]|24[0-9])px',

        'carga_hist_tp' : 'top:(1139[0-9]|1140[0-9]|1141[0-9]|1229[0-9]|1230[0-9]|1315[0-9]|1316[0-9]|1317[0-9]|1318[0-9]|1319[0-9])px',
        'carga_hist_lf' : 'left:(34[0-9]|35[0-9]|36[0-9])px',

        'data_hist_tp' : 'top:(1139[0-9]|1140[0-9]|1141[0-9]|1229[0-9]|1230[0-9]|1315[0-9]|1316[0-9]|1317[0-9]|1318[0-9]|1319[0-9])px',
    ...
    sul = {
        ...
        # Demanda Máxima Instantânea (Página 14)
        'carga_hora_verif_tp' : 'top:(1136[0-9]|1137[0-9]|1138[0-9]|1226[0-9]|1227[0-9]|1315[0-9]|1316[0-9]|1317[0-9])px',
        'carga_hora_verif_lf' : 'left:(22[0-9]|23[0-9]|24[0-9])px',
## TODO expressão do sul é diferente dos outros
        'carga_hist_tp' : 'top:(1136[0-9]|1137[0-9]|1138[0-9]|1226[0-9]|1227[0-9]|1315[0-9]|1316[0-9]|1317[0-9])px',
        'carga_hist_lf' : 'left:(34[0-9]|35[0-9]|36[0-9])px',

        'data_hist_tp' : 'top:(11136[0-9]|1137[0-9]|1138[0-9]|226[0-9]|1227[0-9]|1229[0-9]|1230[0-9]|1315[0-9]|1316[0-9]|1317[0-9])px',
...
#       left:357px; top:12270px
    ...
    nordeste = {
        ...
        # Demanda Máxima Instantânea (Página 14)
        'carga_hora_verif_tp' : 'top:(1142[0-9]|1143[0-9]|1144[0-9]|1231[0-9]|1232[0-9]|1315[0-9]|1316[0-9]|1317[0-9]|1321[0-9]|1322[0-9])px',
        'carga_hora_verif_lf' : 'left:(22[0-9]|23[0-9]|24[0-9])px',

        'carga_hist_tp' : 'top:(1142[0-9]|1143[0-9]|1144[0-9]|1231[0-9]|1232[0-9]|1315[0-9]|1316[0-9]|1317[0-9]|1321[0-9]|1322[0-9])px',
        'carga_hist_lf' : 'left:(34[0-9]|35[0-9]|36[0-9])px',

        'data_hist_tp' : 'top:(1142[0-9]|1143[0-9]|1144[0-9]|1231[0-9]|1232[0-9]|1315[0-9]|1316[0-9]|1317[0-9]|1321[0-9]|1322[0-9])px',
        'data_hist_lf' : 'left:(40[0-9]|41[0-9]|42[0-9])px'        
        }
    ...
    norte = {
        ...
        'prod_verif_lf' : 'left:(14[0-9]|15[0-9]|16[0-9]|17[0-9]|18[0-9])px',
    
        'prod_prog_tp' : 'top:(110[0-9]|111[0-9]|112[0-9])px',  
        'prod_prog_lf' : 'left:(19[0-9]|20[0-9]|21[0-9]|22[0-9]|23[0-9])px',
        ...
        # Demanda Máxima Instantânea (Página 14)
        'carga_hora_verif_tp' : 'top:(1141[0-9]|1142[0-9]|1143[0-9]|1230[0-9]|1231[0-9]|1315[0-9]|1316[0-9]|1317[0-9])px',
        'carga_hora_verif_lf' : 'left:(22[0-9]|23[0-9]|24[0-9])px',   

        'carga_hist_tp' : 'top:(1141[0-9]|1142[0-9]|1143[0-9]|1230[0-9]|1231[0-9]|1232[0-9]|1320[0-9]|1321[0-9])px',
        'carga_hist_lf' : 'left:(34[0-9]|35[0-9]|36[0-9])px',

        'data_hist_tp' : 'top:(1141[0-9]|1142[0-9]|1143[0-9]|1231[0-9]|1232[0-9]|1320[0-9]|1321[0-9])px',
        'data_hist_lf' : 'left:(40[0-9]|41[0-9]|42[0-9])px'      
...
# Intercambio de Energia entre subsistemas      
    intercambio = {
        ...
        'internacional-sul_tp' : 'top:(149[0-9]|150[0-9]|151[0-9]|152[0-9]|153[0-9])px',
